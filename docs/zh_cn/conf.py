...
project = 'MMipt'
copyright = '2023, MMipt Authors'
author = 'MMipt Authors'
...
autodoc_mock_imports = [
    'mmipt.version', 'mmcv._ext', 'mmcv.ops.ModulatedDeformConv2d',
...
html_theme_options = {
    ...
    'menu': [
        {
            'name': 'GitHub',
            'url': 'https://github.com/huaibovip/mmipt',
        },
        {
            'name':
            '版本',
            'children': [
                {
                    'name': 'MMipt 1.x',
                    'url': 'https://mmipt.readthedocs.io/zh_CN/latest/',
                    'description': 'Main 分支文档'
                },
                {
                    'name': 'MMEditing 0.x',
                    'url': 'https://mmipt.readthedocs.io/zh_CN/0.x/',
