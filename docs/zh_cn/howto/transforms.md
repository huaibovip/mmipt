...
在MMipt中，所有数据变换都继承自 `BaseTransform`。
变换的输入和输出类型都是字典。
...
MMipt 支持添加 [Albumentations](https://github.com/albumentations-team/albumentations) 库中的 transformation，请浏览 https://albumentations.ai/docs/getting_started/transforms_and_targets 获取更多 transformation 的信息。
