...
Welcome to the MMipt community!
The MMipt ecosystem consists of tutorials, libraries, and projects from a broad set of researchers in academia and industry, ML and application engineers.
The goal of this ecosystem is to support, accelerate, and aid in your exploration with MMipt for AIGC such as image, video, 3D content generation, editing and processing.

Here are a few projects that are built upon MMipt. They are examples of how to use MMipt as a library, to make your projects more maintainable.
Please find more projects in [MMipt Ecosystem](https://openmmlab.com/ecosystem).
...
## Add example projects to MMipt

Here is an [example project](../../../projects/example_project) about how to add your projects to MMipt.
...
- [Contribution Guide](https://mmipt.readthedocs.io/en/latest/community/contributing.html)

  The guides for new contributors about how to add your projects to MMipt.

- [New Model Guide](https://mmipt.readthedocs.io/en/latest/howto/models.html)

  The documentation of adding new models.

- [Discussions](https://github.com/huaibovip/mmipt/discussions)

  Welcome to start a discussion!

## Projects of libraries and toolboxes

- [PowerVQE](https://github.com/ryanxingql/powervqe): Open framework for quality enhancement of compressed videos based on PyTorch and MMipt.
