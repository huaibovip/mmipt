...
We update model settings in MMipt 1.x. Important modifications are as following.
...
We refactor models in MMipt 1.x. Important modifications are as following.
