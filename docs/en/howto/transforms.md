...
In this tutorial, we introduce the design of transforms pipeline in MMipt.

The structure of this guide are as follows:

- [How to design your own data transforms](#how-to-design-your-own-data-transforms)
  - [Data pipelines in MMipt](#data-pipelines-in-mmipt)
  ...
  - [Supported transforms in MMipt](#supported-transforms-in-mmipt)
...
In MMipt, all data transformations are inherited from `BaseTransform`.
The input and output types of transformations are both dict.

### A simple example of data transform

```python
>>> from mmipt.transforms import LoadPairedImageFromFile
...
pipeline = [
    ...
    dict(
        ...
        transforms=[
            dict(
                type='mmipt.Resize', scale=(286, 286),
                interpolation='bicubic'),
            dict(type='mmipt.FixedCrop', crop_size=(256, 256))
        ]),
    dict(
        type='Flip',
...
MMipt support adding custom transformations from [Albumentations](https://github.com/albumentations-team/albumentations) library. Please visit https://albumentations.ai/docs/getting_started/transforms_and_targets to get more information.
