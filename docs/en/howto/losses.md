...
`losses` are registered as `LOSSES` in `MMipt`.
Customizing losses is similar to customizing any other model.
This section is mainly for clarifying the design of loss modules in MMipt.
...
class MSELoss(nn.Module):
    ...
    def __init__(self, loss_weight=1.0, reduction='mean', sample_wise=False):
        # codes can be found in ``mmipt/models/losses/pixelwise_loss.py``
...
Note that `pixel_loss` above must be defined in the model. Please refer to `customize_models` for more details. Similar to model customization, in order to use your customized loss, you need to import the loss in `mmipt/models/losses/__init__.py` after writing it.
...
However, in `MMipt`, we provide another unified interface `data_info` for users to define the mapping between the input argument and data items.
...
class DiscShiftLoss(nn.Module):
    ...
    def __init__(self, loss_weight=1.0, data_info=None):
        ...
        # codes can be found in ``mmipt/models/losses/disc_auxiliary_loss.py``
...
```
  ...
  <tr>
    ...
    <td>mmipt.models.GradientPenaltyLoss</td>
    <td>
...
```
  ...
  <tr>
    ...
    <td>mmipt.models.DiscShiftLoss</td>
    <td>
...
```
  ...
  <tr>
    <td>clip loss</td>
    <td>mmipt.models.CLIPLoss</td>
    <td></td>

</tr>
  <tr>
    <td>L1 composition loss</td>
    <td>mmipt.models.L1CompositionLoss</td>
    <td></td>

</tr>
  <tr>
    <td>MSE composition loss</td>
    <td>mmipt.models.MSECompositionLoss</td>
    <td></td>

</tr>
  <tr>
    <td>charbonnier composition loss</td>
    <td>mmipt.models.CharbonnierCompLoss</td>
    <td>
...
```
  ...
  <tr>
    <td>face id Loss</td>
    <td>mmipt.models.FaceIdLoss</td>
    <td></td>

</tr>
  <tr>
    <td>light cnn feature loss</td>
    <td>mmipt.models.LightCNNFeatureLoss</td>
    <td>
...
```
  ...
  <tr>
    <td>gradient loss</td>
    <td>mmipt.models.GradientLoss</td>
    <td></td>

</tr>
  <tr>
    <td>l1 Loss</td>
    <td>mmipt.models.L1Loss</td>
    <td>
...
```
  ...
  <tr>
    ...
    <td>mmipt.models.CharbonnierLoss</td>
    <td>
...
```
  ...
  <tr>
    ...
    <td>mmipt.models.MaskedTVLoss</td>
    <td>
...
```
  ...
  <tr>
    ...
    <td>mmipt.models.PerceptualLoss</td>
    <td>
...
```
  ...
  <tr>
    ...
    <td>mmipt.models.TransferalPerceptualLoss</td>
    <td>
...
| Method                               | class                                       |
| ------------------------------------ | ------------------------------------------- |
| clip loss component                  | mmipt.models.CLIPLossComps                 |
| discriminator shift loss component   | mmipt.models. DiscShiftLossComps           |
| gradient penalty loss component      | mmipt.models. GradientPenaltyLossComps     |
| r1 gradient penalty component        | mmipt.models. R1GradientPenaltyComps       |
| face Id loss component               | mmipt.models. FaceIdLossComps              |
| gan loss component                   | mmipt.models. GANLossComps                 |
| generator path regularizer component | mmipt.models.GeneratorPathRegularizerComps |
