...
![mmipt](docs/zh_cn/_static/image/mmipt-logo.png)
...
Developers often encounter the "Unregistered module xxx" error when they fail to trigger registration. To prevent this issue, the MMEngine Template automatically registers the module if developers follow the [default directory structure](#directory-structure). -->
 ...
 <img src="docs/imgs/img1.png" width = "800"  align=center />
 <img src="docs/imgs/img2.png" width = "800"  align=center />
 <img src="docs/imgs/img3.png" width = "800"  align=center />
...
Besides, there are lots of `mmengine-template` or `mmipt` in this project, including file name, module name and scope name, you need to replace them with your own project name before organizing your code.
