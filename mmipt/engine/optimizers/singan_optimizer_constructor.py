...
from mmipt.registry import OPTIM_WRAPPER_CONSTRUCTORS
...
class SinGANOptimWrapperConstructor:
    ...
    :class:`~mmipt.models.editors.singan.SinGANMultiScaleGenerator` and
    :class:`~mmipt.models.editors.singan.SinGANMultiScaleDiscriminator`.
