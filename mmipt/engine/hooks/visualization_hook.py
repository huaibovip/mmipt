...
from mmipt.utils import get_sampler
...
class VisualizationHook(Hook):
    """MMipt Visualization Hook. Used to visual output samples in training,
    ...
    - Required key words:
        - 'type': Value must be string. Denotes what kind of sampler is used to
            generate image. Refers to :meth:`~mmipt.utils.get_sampler`.
    ...
    models supported in MMipt. Refers to
