...
from mmipt.registry import EVALUATORS
...
class Evaluator(Evaluator):
    ...
    Score (IS, :class:`~mmipt.evaluation.InceptionScore`) only needs to
    take fake images as input. However, Frechet Inception Distance (FID,
    :class:`~mmipt.evaluation.FrechetInceptionDistance`) needs to take
    ...
    :class:`~mmipt.evaluation.PerceptualPathLength`), generator need
    ...
    :meth:`mmipt.engine.runner.MultiValLoop.run` and
    :meth:`mmipt.engine.runner.MultiTestLoop.run`.
