...
from mmipt.registry import VISBACKENDS


@VISBACKENDS.register_module()
class VisBackend(BaseVisBackend):
    """mmipt visualization backend class. It can write image, config, scalars,
    ...
    Examples:
        >>> from mmipt.visualization import VisBackend
        >>> import numpy as np
...
class WandbVisBackend(BaseWandbVisBackend):
    """Wandb visualization backend for mmipt."""
