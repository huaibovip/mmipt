...
DATASETS = Registry(
    'dataset', parent=MMENGINE_DATASETS, locations=['mmipt.datasets'])
# Samplers to sample the dataset.
DATA_SAMPLERS = Registry(
    'data sampler',
    parent=MMENGINE_DATA_SAMPLERS,
    locations=['mmipt.datasets'],
)
# Transforms to process the samples from the dataset.
TRANSFORMS = Registry(
    'transform',
    parent=MMENGINE_TRANSFORMS,
    locations=['mmipt.datasets.transforms'])
...
DIFFUSION_SCHEDULERS = Registry(
    'diffusion scheduler',
    locations=['mmipt.models.diffusion_schedulers'],
)
