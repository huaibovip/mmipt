...
from mmipt.utils.typing import ForwardInputs, NoiseVar, SampleList
...
class BaseGAN(BaseModel, metaclass=ABCMeta):
    ...
    @staticmethod
    def gather_log_vars(
            log_vars_list: List[Dict[str, Tensor]]) -> Dict[str, Tensor]:
    ...
    def train_step(self, data: dict,
        ...
        discriminator are updated alternatively. In MMipt's design,
    ...
    def train_discriminator(
            self, inputs: dict, data_samples: List[DataSample],
            optimizer_wrapper: OptimWrapper) -> Dict[str, Tensor]:
        """Training function for discriminator. All GANs should implement this
        function by themselves.
