...
from mmipt.models.base_models import BaseGAN
from mmipt.models.losses import gradient_penalty_loss
...
class WGANGP(BaseGAN):
    ...
    :class:`~mmipt.models.editors.wgan_gp.WGANGPGenerator`
    and
    :class:`~mmipt.models.editors.wgan_gp.WGANGPDiscriminator`
    """
