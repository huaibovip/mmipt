...
from mmipt.utils.typing import ForwardInputs, SampleList
...
class EG3D(BaseConditionalGAN):
    ...
    :class:`~mmipt.models.editors.eg3d.eg3d_generator.TriplaneGenerator`
    and
    :class:`~mmipt.models.editors.eg3d.dual_discriminator.DualDiscriminator`
    ...
    Args:
        ...
        data_preprocessor (Optional[Union[dict, Config]]): The pre-process
            config or :class:`~mmipt.models.DataPreprocessor`.
    ...
    def data_sample_to_label(
            self, data_sample: SampleList) -> Optional[torch.Tensor]:
