...
class StyleGAN2(BaseGAN):
    ...
    :class:`~mmipt.models.editors.stylegan2.StyleGAN2Generator`
    and
    :class:`~mmipt.models.editors.stylegan2.StyleGAN2Discriminator`
    ...
    def train_discriminator(
            self, inputs: dict, data_samples: DataSample,
