    ...
    *FD* is the abstract class for finite differences. It includes most of the actual finite difference code,
    ...
    def __init__(self, spacing, mode='linear'):
        ...
        assert mode in [
            ...
            mode)
        self.bcNeumannZero = (mode == 'neumann_zero'
    ...
    def dXc(self, I):
        ...
        """
        res = (self.xp(I, central=True) -
               self.xm(I, central=True)) * (0.5 / self.spacing[0])
        return res
    ...
    def ddXc(self, I):
        ...
        """
        res = (self.xp(I, central=True) - I - I +
               self.xm(I, central=True)) * (1 / (self.spacing[0]**2))
        return res
    ...
    def dYc(self, I):
        ...
        """
        res = (self.yp(I, central=True) -
               self.ym(I, central=True)) * (0.5 / self.spacing[1])
        return res
    ...
    def ddYc(self, I):
        ...
        """
        res = (self.yp(I, central=True) - I - I +
               self.ym(I, central=True)) * (1 / (self.spacing[1]**2))
        return res
    ...
    def dZc(self, I):
        ...
        """
        res = (self.zp(I, central=True) -
               self.zm(I, central=True)) * (0.5 / self.spacing[2])
        return res
    ...
    def ddZc(self, I):
        ...
        """
        res = (self.zp(I, central=True) - I - I +
               self.zm(I, central=True)) * (1 / (self.spacing[2]**2))
        return res
    ...
    def create_zero_array(self, sz):
        """Abstract method to create a zero array of a given size, sz. E.g.,
        sz=[10,2,5]
