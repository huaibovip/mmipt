...
def build_mmipt_wrapper_tomesd_block(
        block_class: Type[torch.nn.Module]) -> Type[torch.nn.Module]:
    """Make a patched class for a DiffusersWrapper model in mmipt. This patch
...
def build_mmipt_tomesd_block(
        block_class: Type[torch.nn.Module]) -> Type[torch.nn.Module]:
    """Make a patched class for a mmipt StableDiffusion model. This patch
    applies ToMe to the forward function of the block.
