...
from mmipt.models import CycleGAN, DataPreprocessor
from mmipt.models.archs import PatchDiscriminator
from mmipt.models.editors.cyclegan import ResnetGenerator
