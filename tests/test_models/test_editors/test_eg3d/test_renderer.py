...
from mmipt.models.editors.eg3d.renderer import EG3DDecoder, EG3DRenderer
...
class TestEG3DRenderer(TestCase):
    ...
    def test_forward(self):
        ...
        mock_path = ('mmipt.models.editors.eg3d.renderer.EG3DRenderer.'
                     'volume_rendering')
        ...
        mock_path = 'mmipt.models.editors.eg3d.renderer.TORCH_VERSION'
