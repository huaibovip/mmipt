...
from mmipt.models import DenoisingUnet, DiscoDiffusion
from mmipt.models.diffusion_schedulers import EditDDIMScheduler
...
class TestDiscoDiffusion(TestCase):
    ...
    def test_infer(self):
        ...
        mock_path = ('mmipt.models.editors.disco_diffusion.guider.'
                     'TORCHVISION_VERSION')
        affine_mock_path = ('mmipt.models.editors.disco_diffusion.guider.T.'
                            'RandomAffine')
