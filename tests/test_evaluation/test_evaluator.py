...
from mmipt.evaluation import (Evaluator, FrechetInceptionDistance,
                              InceptionScore)
...
fid_loading_str = 'mmipt.evaluation.metrics.fid.FrechetInceptionDistance._load_inception'  # noqa
is_loading_str = 'mmipt.evaluation.metrics.inception_score.InceptionScore._load_inception'  # noqa
...
class TestEvaluator(TestCase):
    ...
    def test_prepare_metric(self):
        ...
        with patch('mmipt.evaluation.metrics.fid.prepare_inception_feat'):
