...
from mmipt.visualization import (PaviVisBackend, TensorboardVisBackend,
...
class TestVisBackend(TestCase):
    ...
    def test_vis_backend(self):
        ...
        config = Config(dict(work_dir='./mmipt/test/vis_backend_test/'))
        ...
        src_path = osp.abspath(
            './mmipt/test/vis_backend_test/test_vis_data/test.png')
